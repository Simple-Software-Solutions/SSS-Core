...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\SSS
// Windows >= Vista: C:\Users\Username\AppData\Roaming\SSS
// Mac: ~/Library/Application Support/SSS
// Unix: ~/.sss
#ifdef WIN32
    // Windows
...
{
    fs::path pathConfigFile(GetArg("-conf", "sss.conf"));
...
fs::path GetPidFile()
{
    fs::path pathPidFile(GetArg("-pid", "sssolutionsd.pid"));
