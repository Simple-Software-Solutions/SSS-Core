...
/** Utility functions used by the sssolutions Qt UI.
 */
namespace GUIUtil
{
...
// Render sssolutions addresses in monospace font
...
// Parse "sssolutions:" URI into recipient object, return true on successful parsing
