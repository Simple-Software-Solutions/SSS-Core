...
/** Utility functions used by the SSS Qt UI.
 */
namespace GUIUtil
{
...
// Render SSS addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool iszSSS = false);
