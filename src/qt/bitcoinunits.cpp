...
QString BitcoinUnits::name(int unit, bool iszSSS)
{
    QString z = "";
    if(iszSSS) z = "z";
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case SSS:
            return z + QString("SSS");
        case mSSS:
            return z + QString("mSSS");
        case uSSS:
            return z + QString::fromUtf8("μSSS");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SSS:
            return z + QString("tSSS");
        case mSSS:
            return z + QString("mtSSS");
        case uSSS:
            return z + QString::fromUtf8("μtSSS");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSSS)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZSSS);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSSS)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZSSS));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
