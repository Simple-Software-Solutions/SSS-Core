...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizesssolutionsAmount"))
        settings.setValue("nAnonymizesssolutionsAmount", 1000);

    nAnonymizesssolutionsAmount = settings.value("nAnonymizesssolutionsAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizesssolutionsAmount"))
        SoftSetArg("-anonymizesssolutionsamount", settings.value("nAnonymizesssolutionsAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in sssolutions.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizesssolutionsAmount:
            return QVariant(nAnonymizesssolutionsAmount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case HideOrphans:
            ...
            break;
        case AnonymizesssolutionsAmount:
            nAnonymizesssolutionsAmount = value.toInt();
            settings.setValue("nAnonymizesssolutionsAmount", nAnonymizesssolutionsAmount);
            emit anonymizesssolutionsAmountChanged(nAnonymizesssolutionsAmount);
            break;
        case CoinControlFeatures:
