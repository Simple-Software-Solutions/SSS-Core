...
#ifndef SSS_CORE_NEW_GUI_SSSGUI_H
#define SSS_CORE_NEW_GUI_SSSGUI_H
...
#include "qt/sss/navmenuwidget.h"
#include "qt/sss/topbar.h"
#include "qt/sss/dashboardwidget.h"
#include "qt/sss/send.h"
#include "qt/sss/receivewidget.h"
...
/**
  SSS GUI main class. This class represents the main window of the SSS UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SSSGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SSSGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~SSSGUI();
...
#endif //SSS_CORE_NEW_GUI_SSSGUI_H
