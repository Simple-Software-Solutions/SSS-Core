...
#include "qt/sss/forms/ui_masternodeswidget.h"

#include "qt/sss/qtutils.h"
#include "qt/sss/mnrow.h"
#include "qt/sss/mninfodialog.h"
...
MasterNodesWidget::MasterNodesWidget(SSSGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * 2500)) {
