...
#include "qt/sss/forms/ui_coldstakingwidget.h"
#include "qt/sss/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/sss/requestdialog.h"
#include "qt/sss/tooltipmenu.h"
#include "qt/sss/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(SSSGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your SSSs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept SSS delegation / Delegate SSS"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select SSS outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 SSS" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
