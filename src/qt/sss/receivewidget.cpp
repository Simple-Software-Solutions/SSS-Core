...
#include "qt/sss/forms/ui_receivewidget.h"
...
#include "qt/sss/addressholder.h"
...
ReceiveWidget::ReceiveWidget(SSSGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive SSS."));
