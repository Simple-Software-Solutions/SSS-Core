...
#include "qt/sss/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(SSSGUI *parent) :
    QDialog(parent),
    ui(new Ui::SendCustomFeeDialog)
{
    ...
    if (parent)
        connect(parent, &SSSGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
