...
#include "qt/sss/settings/settingsnetworkwidget.h"
#include "qt/sss/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/sss/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SSSGUI* _window, QWidget *parent) :
