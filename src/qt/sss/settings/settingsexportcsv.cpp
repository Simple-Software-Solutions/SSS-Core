...
#include "qt/sss/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(SSSGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("SSS_tx_csv_export(*.csv)") : tr("SSS_addresses_csv_export(*.csv)"),
                                        nullptr);
