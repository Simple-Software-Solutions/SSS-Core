...
#include "qt/sss/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/sss/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(SSSGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory){
    ...
    message(CMD_REPLY, (tr("Welcome to the SSS RPC console.") + "<br>" +
