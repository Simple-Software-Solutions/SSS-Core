...
#include "qt/sss/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/sss/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(SSSGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    if (parent)
        connect(parent, &SSSGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
