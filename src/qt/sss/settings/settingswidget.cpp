...
#include "qt/sss/settings/forms/ui_settingswidget.h"
#include "qt/sss/settings/settingsbackupwallet.h"
#include "qt/sss/settings/settingsbittoolwidget.h"
#include "qt/sss/settings/settingswalletrepairwidget.h"
#include "qt/sss/settings/settingswalletoptionswidget.h"
#include "qt/sss/settings/settingsmainoptionswidget.h"
#include "qt/sss/settings/settingsdisplayoptionswidget.h"
#include "qt/sss/settings/settingsmultisendwidget.h"
#include "qt/sss/settings/settingsinformationwidget.h"
#include "qt/sss/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(SSSGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &SSSGUI::openFAQ);
