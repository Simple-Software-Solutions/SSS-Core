...
#include "qt/sss/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/sss/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SSSGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SSSGUI::handleRestart()
