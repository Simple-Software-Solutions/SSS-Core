...
#include "qt/sss/forms/ui_dashboardwidget.h"
#include "qt/sss/sendconfirmdialog.h"
#include "qt/sss/txrow.h"
...
DashboardWidget::DashboardWidget(SSSGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &SSSGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
...
void DashboardWidget::loadWalletModel()
{
    if (walletModel && walletModel->getOptionsModel()) {
        ...
        connect(ui->pushImgEmpty, &QPushButton::clicked, window, &SSSGUI::openFAQ);
        connect(ui->btnHowTo, &QPushButton::clicked, window, &SSSGUI::openFAQ);
