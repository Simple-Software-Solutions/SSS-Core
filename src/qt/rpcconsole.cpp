                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzsssPathCustom = GetArg("-zsssbackuppath", "");
    ...
    if(!strzsssPathCustom.empty()) {
        ui->wallet_customzsssbackuppath->setText(QString::fromStdString(strzsssPathCustom));
        ui->wallet_customzsssbackuppath_label->setVisible(true);
        ui->wallet_customzsssbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzsssPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SSSolutions RPC console.") + "<br>" +
