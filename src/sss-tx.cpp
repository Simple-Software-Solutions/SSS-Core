...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SSS Core sssolutions-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sssolutions-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sss transaction") + "\n" +
                               "  sssolutions-tx [options] -create [commands]   " + _("Create hex-encoded sss transaction") + "\n" +
                               "\n";
