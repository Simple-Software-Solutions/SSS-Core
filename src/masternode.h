...
//
// The Masternode Class. It contains the input of the 2500 SSS, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 2500 SSS - checking if valid masternode)
