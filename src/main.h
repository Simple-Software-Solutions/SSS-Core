...
static const unsigned int MAX_STANDARD_TX_SIZE = 1500000;
...
bool CheckBlock(const CBlock& block, CValidationState& state, bool fCheckPow = false, bool fCheckMerkleRoot = true, bool fCheckSig = true);
...
bool TestBlockValidity(CValidationState& state, const CBlock& block, CBlockIndex* pindexPrev, bool fCheckPow = false, bool fCheckMerkleRoot = true);
