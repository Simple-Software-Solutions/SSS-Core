...
/**
 * sssolutions RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzsssseed(const UniValue& params, bool fHelp);
extern UniValue getzsssseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzsss(const UniValue& params, bool fHelp);
extern UniValue dzsssstate(const UniValue& params, bool fHelp);
