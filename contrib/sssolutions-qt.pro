...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/sssolutions-config.h \
           src/crypto/common.h \
...
TRANSLATIONS += src/qt/locale/sssolutions_bg.ts \
                src/qt/locale/sssolutions_de.ts \
                src/qt/locale/sssolutions_en.ts \
                src/qt/locale/sssolutions_es.ts \
                src/qt/locale/sssolutions_fi.ts \
                src/qt/locale/sssolutions_fr.ts \
                src/qt/locale/sssolutions_it.ts \
                src/qt/locale/sssolutions_ja.ts \
                src/qt/locale/sssolutions_pl.ts \
                src/qt/locale/sssolutions_pt.ts \
                src/qt/locale/sssolutions_ru.ts \
                src/qt/locale/sssolutions_sk.ts \
                src/qt/locale/sssolutions_sv.ts \
                src/qt/locale/sssolutions_vi.ts \
                src/qt/locale/sssolutions_zh_CN.ts \
                src/qt/locale/sssolutions_zh_TW.ts
