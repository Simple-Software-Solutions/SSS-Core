...
"""Verify that starting sss with -h works as expected."""
import subprocess

from test_framework.test_framework import sssTestFramework
from test_framework.util import assert_equal

class HelpTest(sssTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sss with -h for help text")
        ...
        self.log.info("Start sss with -version for version information")
