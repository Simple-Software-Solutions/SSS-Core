...
class BitcoinTestFramework():
    """Base class for a sssolutions test script.

    Individual sssolutions test scripts should subclass this class and override the set_test_params() and run_test() methods.
    ...
    def _initialize_chain(self):
        ...
        if create_cache:
            ...
            for i in range(MAX_NODES):
                ...
                args = [os.getenv("BITCOIND", "sssolutionsd"), "-spendzeroconfchange=1", "-server", "-keypool=1", "-datadir=" + datadir, "-discover=0"]
                if i > 0:
