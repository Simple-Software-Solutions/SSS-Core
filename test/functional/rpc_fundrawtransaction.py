...
class RawTransactionsTest(sssTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid sss address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid sss address" in e.error['message'])
