#!/usr/bin/env python3
# Copyright (c) 2019 The SSSolutions Core developers
...
from fake_stake.base_test import sssolutions_FakeStakeTest

class zssswrappedSerialsTest(sssolutions_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zssss..." % DENOM_TO_USE)
