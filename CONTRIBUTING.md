...
The SSS Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Simple-Software-Solutions/SSS-Core/blob/master/doc/translation_process.md)
...
Where a patchset proposes to change the SSS consensus, it must have been
