Contributing to SSSolutions Core
============================

The SSSolutions Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SSSolutions Core project, and is not to be
confused with overall SSSolutions Network Protocol consensus changes.

Whether a pull request is merged into SSSolutions Core rests with the project merge
...
Patches that change sssolutions consensus rules are considerably more involved than
...
Where a patch set proposes to change the SSSolutions consensus, it must have been
...
The project leader is the release manager for each SSSolutions Core release.
