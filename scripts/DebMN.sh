...
COIN_REPO='https://github.com/Liquid369/sssolutions'
COIN_TGZ='https://transfer.sh/RpGW3/sssolutionsd.7z'
...
# unzip sssolutions.zip
#tar xvzf sssolutions-3.1.0-x86_64-linux-gnu.tar.gz
#cd sssolutions-3.1.0/bin
apt-get install -y p7zip-full
7z e sssolutionsd.7z
chmod -R 775 *
cp * $COIN_PATH
cd ..
cd $COIN_PATH
...
function blocks() {
	wget https://github.com/sssolutions/sssolutions/raw/master/blocks.sh
	chmod 777 blocks.sh 
	bash blocks.sh
...
function save_key() {
	cd /root/.sssolutions
	mv /root/.sssolutions/sssolutions.conf /root/.sssolutions/sssolutions_old.conf
	cp /root/.sssolutions/sssolutions_old.conf /root
}

function restore_key() {
	cd /root/.sssolutions
	rm masternode.conf
	cp /root/sssolutions_old.conf /root/.sssolutions
	mv /root/.sssolutions/sssolutions_old.conf /root/.sssolutions/sssolutions.conf
}
...
function backup() {
	...
	rm -rf blocks-
	rm blocks.sh
	zip -r backupdg.zip /root/.sssolutions
	cp /root/.sssolutions/backupdg.zip /root
...
function prepare_system() {
 cd ~
   wget https://gist.githubusercontent.com/Liquid369/eca7f89b6c4e63f9b328d92a4f508626/raw/ba14590e3f600acdf8683eeb16cc8b2f9c8fb23e/sss.txt
#  wget https://gist.githubusercontent.com/hoserdude/9661c9cdc4b59cf5f001/raw/5972d4d838691c1a1f33fb274f97fa0b403d10bd/doge.txt
  cat sss.txt
printf "%s\n"
echo "SSSolutions MN installer Depends Starting"
