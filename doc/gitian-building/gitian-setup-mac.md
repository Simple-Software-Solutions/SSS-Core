...
The build script we'll be using is contained in the SSS github repository ([contrib/gitian-build.py](https://github.com/Simple-Software-Solutions/SSS-Core/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the SSS repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/sss-core/SSS/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, sss-detached-sigs, and sss GitHub repos.
