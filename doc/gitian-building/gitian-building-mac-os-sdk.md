...
The script [extract-osx-sdk.sh](https://github.com/Simple-Software-Solutions/SSS-Core/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/Simple-Software-Solutions/SSS-Core/blob/master/doc/README_osx.md) for troubleshooting tips.